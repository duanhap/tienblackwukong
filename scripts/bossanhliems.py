...
class BossAnhLiems(PhysicsEntity):
    ...
    def update(self, tilemap, movement=(0, 0)):
        ...
        if not self.chuanbixong:
            ...
            if abs(disx1) >50 and self.landaugap:
                ...
                if self.walking:# xử lý đi trên vùng ok , chạm trái phải thì lật
                    ...
                    if not self.walking  and self.hp>0 and self.dead== False:
                        ...
                        if (abs(dis[1]) < 500) and abs(dis[0])<1000:
                            ...
                            if   abs(dis_main9)<350 and self.action!='tialazemax' and self.action!='luot' and self.action!='xuathien' and self.action!='die':
                ...
                if self.action =='block':
                    ...
                    if self.animation.done:
                        ...
                        if random.randint(0,10)<7:
                            ...
                            if (not self.flip and dis_main9 > 0):
                                    self.attacking = True
                                    self.dangdungchieukhac = True
    ...
    def render(self, surf, offset=(0, 0)):
        ...
        elif self.action =='tialazemax' or self.action =='nemriu':
        ...
        elif  self.action=='die' or self.action == 'xuathien':
            self.anim_offset=(-900,-1100)  
